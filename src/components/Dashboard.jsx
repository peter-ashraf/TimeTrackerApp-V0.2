    ...
    <main className="main-content">
      ...
      <div className="quick-stats">
        <div className="quick-stat-card">
          <div className="quick-stat-label">Current Period</div>
          <div className="quick-stat-value">{currentPeriod?.label || 'No Period'}</div>
          <div className="quick-stat-subtitle">Pay Period</div>
        </div>
        <div className="quick-stat-card">
          <div className="quick-stat-label">Overtime</div>
          <div className="quick-stat-value" style={{color: overtime >= 0 ? 'var(--color-success)' : 'var(--color-error)'}}>
            {overtime.toFixed(2)}h
          </div>
          <div className="quick-stat-subtitle">Extra Hours</div>
        </div>
        <div className="quick-stat-card">
          <div className="quick-stat-label">Vacation Balance</div>
          <div className="quick-stat-value">{vacationBalance.toFixed(1)}</div>
          <div className="quick-stat-subtitle">Days Available</div>
        </div>
        <div className="quick-stat-card">
          <div className="quick-stat-label">Sick Balance</div>
          <div className="quick-stat-value">{sickBalance.toFixed(1)}</div>
          <div className="quick-stat-subtitle">Days Available</div>
        </div>
      </div>
